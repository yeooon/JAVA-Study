...
public class Test172
{
	...
	public static void main(String[] args)
	{
		...
		// ht 라는 Hashtable 자료구조 배열(names, tels)에 담겨있는
		// 데이터를 요소로 담아내기
		// → put(k, v);
		...
		//ht.put("홍은혜", null); //-- value 가 null		  → 런타임 에러
		//--==>> 에러 발생(런타임 에러)
		//		 NullPointerException
		//ht.put(null, "010-1234-2345");	//-- key 가 null  → 런타임 에러
		//--==>> 에러 발생(런타임 에러)
		//		 NullPointerException
		...
		System.out.println();
		//--==>> 010-1111-1111
		//-- 기존 01044230463 에서 01011111111 로 변경되었음을 확인
		// (덮어쓰기 개념)
