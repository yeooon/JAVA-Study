...
/*
Wrapper 클래스
1. 자바에서는 언어 수준에서 제공하는 기본형 데이터를 제외한 나머지는 클래스로 정의하여 객체 단위로 처리한다.
...
기본형과 마찬가지로 Wrapper 클랫도 내부 메소드를 통해 
형 변환이 가능하고 동등 비교와 같은 연산도 가능하다.

ex) java.lang.Integer 클래스
int 기본 자료형의 Wrapper 클래스로
정수를 다루는데 필요한 상수나 메소드, 진수 변환 등에 필요한 메소드 등을 포함하고 있다.
...
○ 오토 박싱(Auto-Boxing)과 오토 언박싱(Auto-Unboxing)
	...
	Integer ob;
	ob = a;		// 박싱
	//-- 기본 자료형(int)이 Integer 형으로 자동 변환(오토박싱)
...
public class Test132
{
	public static void main(String[] args)
	{
		...
		d= new Object();		//d는 object 타입의 참조변수
		System.out.println("d.toString() : " + d.toString());	//java.lang.Object@15db9742 클래스 해시코드

		d= new Integer(10);		//업 캐스팅 → new Object() = new Object(10);
		System.out.println("d.toString() : " + d.toString());
		//d.toString() : 10

		d= new Double(12.345);		//업 캐스팅 → new Object() = new Object(10);
		System.out.println("d.toString() : " + d.toString());
		//d.toString() : 12.345
