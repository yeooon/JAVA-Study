...
○ 객체 직렬화(Object Serialization)는
	...
	만들어조는 것으로 이 때, 객체란 멤버 변수의 메모리만으로 구성된 것을 말한다.
...
○ Object Stream
	...
	ObjectInputStream 클래스는 ObjectOutputStream(바이트기반) 클래스에 의해
...
public class Test179
{
	public static void main(String[] args) throws Exception
	{
		...
		//-- appDir → C:\JavaStudy
		//-- appDir 위치를 기준으로(중심으로) "\\dir\\test.ser" 를
		// 구성하겠다는 의미
		// 결과적으로 『C:\JavaStudy\dir\test.ser』 구성.
