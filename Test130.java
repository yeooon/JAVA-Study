...
public class Test130
{
	public static void main(String[] args)
	{
		...
		//	※ 객체(Object)들을 비교하는 과정에서 사용하는 == 연산자
		// 크기를 비교하는 것이 아니라 객체의 주소를 비교.

		System.out.println("ob1.equals(ob2) : " +ob1.equals(ob2)); //ob라는 인스턴스 안에 이퀄스라는 메소드 호출
		...
		System.out.println("ob2.toString()  : " + ob1.toString());
//ob1             : Test@15db9742
//ob2.toString()  : Test@15db9742
